...
import static gmap.polyline.MathUtil.EARTH_RADIUS;
import static gmap.polyline.MathUtil.clamp;
import static gmap.polyline.MathUtil.hav;
import static gmap.polyline.MathUtil.havDistance;
import static gmap.polyline.MathUtil.havFromSin;
import static gmap.polyline.MathUtil.inverseMercator;
import static gmap.polyline.MathUtil.mercator;
import static gmap.polyline.MathUtil.sinFromHav;
import static gmap.polyline.MathUtil.sinSumFromHav;
import static gmap.polyline.MathUtil.wrap;
import static gmap.polyline.SphericalUtil.computeDistanceBetween;
